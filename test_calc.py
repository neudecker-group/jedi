...
ALKANES = [
    ...
    (20, "icosane"),     (21, "henicosane"), (22, "docosane"),   (23, "tricosane"),
    (24, "tetracosane"), (25, "pentacosane"),(26, "hexacosane"), (27, "heptacosane"),
...
for c, name in ALKANES:
    ...
    results.append({"version": "python-new", "molecule": name,
                    "carbons": c, "n_atoms": n_atoms, "seconds": best})
