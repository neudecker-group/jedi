...
def deds_analysis(deds_opt, deds_rim_list, deds_ref):
    proc_E_RIMs, E_RIMs, E_RIMs_total, proc_geom_RIMs, delta_q = jedi_analysis(deds_opt,
                                                                               deds_rim_list,
                                                                               deds_ref["bmatrix"],
...
def hcn_analysis(hcn_opt, hcn_rim_list, hcn_ref):
    proc_E_RIMs, E_RIMs, E_RIMs_total, proc_geom_RIMs, delta_q = jedi_analysis(hcn_opt,
                                                                               hcn_rim_list,
                                                                               hcn_ref["bmatrix"],
