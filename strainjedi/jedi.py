...
#            raise GeneratorExit
  ...
  # for loops for all redunant internal coordinates
    ...
    def visualize(self,
        ...
        if visualizer == 'mpl':
            vis = MatplotlibVisualizer(self.visualization_data,
                                mapper,
                                output_dir,
                                energy_unit)
            ...
            vis = VMDVisualizer(self.visualization_data,
                                mapper,
                                output_dir,
                                energy_unit)
    ...
    def vmd_gen(self,
        ...
        warnings.warn("vmd_gen() is deprecated. "
        "Please use visualize(visualizer='vmd') instead.",
        DeprecationWarning)

        if not incl_coloring:
            incl_coloring = 'green_red'
        self.visualize(visualizer='vmd',
